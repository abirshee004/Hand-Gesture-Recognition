        ...
        for hand_landmark in results.multi_hand_landmarks:
            ...
            if all(finger_fold_status):
                ...
                if lm_list[thumb_tip].y > lm_list[thumb_tip - 1].y > lm_list[thumb_tip - 2].y and lm_list[0].x < lm_list[3].y:
                    ...
                    print("DISLIKE")
                #Rock on   
                if lm_list[thumb_tip].y < lm_list[thumb_tip - 1].y and lm_list[4].y > lm_list[5].y:
                    cv2.putText(img, "ROCK ON", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3)
                    print("ROCK ON")
                ...
                if lm_list[thumb_tip].y > lm_list[thumb_tip - 1].y > lm_list[thumb_tip - 2].y and lm_list[0].x < lm_list[3].y:
                    ...
                    print("STOP")
                    # h, w, c = stop_hand_sign.shape
                    # img[35:h + 35, 30:w + 30] = stop_hand_sign
            ...
            mp_draw.draw_landmarks(img, hand_landmark,
                                   ...
                                   #mp_draw.DrawingSpec((255, 0, 0), 6, 2)
                                   )
